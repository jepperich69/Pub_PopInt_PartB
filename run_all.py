...
STAGES = [
    ...
    ("supplement", "analysis/supplement_checks.py",
     "Mathematical Supplement S2-S6: identities, bounds, examples, Danish-table quantities", {}),
    ("kl_vs_ml", "analysis/kl_vs_ml_ranking.py",
     "Supplement S3: KL minimizer vs most probable table, disagreement rate by N", {}),
